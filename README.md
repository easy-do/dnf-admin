...
- 新增windwos独立使用版，下载地址在release的网盘分享
...
- 该版本关闭了依赖服务端和frida的部分功能,不需要部署到服务器,直接在桌面即可打开使用（注意:这个版本就是纯GM工具）。

- 点击链接进入发行版获取 https://gitee.com/yuzhanfeng/dnf-admin/releases/tag/1.0.3
